...
public class BankFrame extends JFrame {
    ...
    private final AccountDAO readOnlyDao;
    ...
    public BankFrame() {
        ...
        try {
            readOnlyDao = new AccountDAO(DatabaseManager.getInstance().getConnection());
    ...
    private void refreshTable() {
        ...
        List<Account> accounts = readOnlyDao.findAll();
